...
static VOID (WINAPI *og_FatalExit)(int ExitCode) = FatalExit;
static VOID WINAPI hooked_FatalExit(int ExitCode) {

	SEND_BEFORE_CALL(6291)
...
static bool WINAPI hooked_IsActiveSessionCountLimited() {
	...
	SEND_BEFORE_CALL(8336)

	
	bool ret;
    TIME({ ret = og_IsActiveSessionCountLimited(); });
